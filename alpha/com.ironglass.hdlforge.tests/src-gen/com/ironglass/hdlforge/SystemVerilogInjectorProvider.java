...
public class SystemVerilogInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new SystemVerilogStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
